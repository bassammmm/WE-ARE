...
public static class NxPMenuItems
{
    ...
    public static void CreateNexPlayerUI(MenuCommand menuCommand)
    {
        ...
        string file = string.Concat(Application.dataPath, "/NexPlayer/Prefabs/NexPlayerUI.json");
    ...
    public static void CreateNexPlayerSamples(MenuCommand menuCommand)
    {
        ...
        PrefabSystem system = new PrefabSystem();
        // EDITOR MANAGER
        string file = string.Concat(Application.dataPath, "/NexPlayer/Prefabs/NexPlayerSamples.json");
